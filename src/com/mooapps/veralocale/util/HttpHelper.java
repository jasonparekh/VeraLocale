// This class was taken from http://code.google.com/p/and-bookworm/source/browse/trunk/src/com/totsp/bookworm/data/HttpHelper.java
// The following modifications were made:
// - Reformat
// - Throw exception on errors

package com.mooapps.veralocale.util;
...
public class HttpHelper {
     ...
     *
     */
    public String performGet(final String url) throws RequestFailedException {
    ...
    public String performPost(final String url, final String user,
            final String pass, final Map<String, String> additionalHeaders,
            final Map<String, String> params) throws RequestFailedException {
